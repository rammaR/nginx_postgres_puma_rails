class TelevisionsController < ApplicationController
  ...
  def redir
    respond_to do |format|
      if @television.save
        format.html { redirect_to television_url(@television), notice: "Television was successfully created." }
  ...
  def update
    respond_to do |format|
      if @television.update(television_params)
        format.html { redirect_to television_url(@television), notice: "Television was successfully updated." }
  ...
  private
    ...
    def television_params
      params.require(:television).permit(:screen, :type, :price)
    end
end
